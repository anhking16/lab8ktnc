...
<body>
    ...
    <form action="User  Servlet" method="post">
        <input type="hidden" name="id" id="userId" value="<%= request.getAttribute("id") != null ? request.getAttribute("id") : "" %>" />
        Tên người dùng: <input type="text" name="username" value="<%= request.getAttribute("username") != null ? request.getAttribute("username") : "" %>" required /><br/>
