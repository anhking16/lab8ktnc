...
public class UserManager {
    EntityManagerFactory factory = Persistence.createEntityManagerFactory("PolyOE1");
    ...
    // Tìm kiếm người dùng với email kết thúc bằng "@fpt.edu.vn" và không phải là admin
