...
<body>
    <div class="container">
        ...
        <!-- Form tìm kiếm -->
        <form action="departments" method="get" class="form-inline mb-3">
        ...
        <form action="departments" method="post" class="form-inline mb-3">
            ...
            <tbody>
                <c:forEach var="department" items="${departments}">
                    <tr>
                        ...
                        <td>
                            <!-- Nút sửa -->
                            <a href="departments?action=edit&id=${department.id}" class="btn btn-warning">Sửa</a>

                            <!-- Nút xóa -->
                            <a href="departments?action=delete&id=${department.id}" class="btn btn-danger" 
