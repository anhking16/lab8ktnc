...
<body>
    <div class="container">
        ...
        <!-- Form tìm kiếm -->
        <form action="/Slide6_java3_fall2024/departments4/search" method="get" class="form-inline mb-3">
        ...
        <form action="${department != null ? '/Slide6_java3_fall2024/departments4/sua' : '/Slide6_java3_fall2024/departments4/them'}" method="post" class="form-inline mb-3">
            ...
            <tbody>
                <c:forEach var="department" items="${departments}">
                    <tr>
                        ...
                        <td>
                            <!-- Nút sửa -->
                            <a href="/Slide6_java3_fall2024/departments4/sua?id=${department.id}" class="btn btn-warning">Sửa</a>

                            <!-- Nút xóa -->
                            <a href="/Slide6_java3_fall2024/departments4/xoa?id=${department.id}" class="btn btn-danger" 
                               onclick="return confirm('Bạn có chắc chắn muốn xóa không?');">Xóa</a>
                               
                            <a href="/Slide6_java3_fall2024/department-details/${department.id}" class="link-success">Chi tiết</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
